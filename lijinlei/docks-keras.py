...
def main():
    ...
    # with open('./models/docks-keras.yaml', 'w') as outfile:
        # outfile.write(yaml_string)
    model.save('docks-keras-model.h5')


def pred_data():

    # with open('./models/docks-keras.yaml') as yamlfile:
        # loaded_model_yaml = yamlfile.read()
    # model = model_from_yaml(loaded_model_yaml)
    model = load_model('docks-keras-model.h5')
